...
def visual_extraction():
    ...
    English_drama_path = r'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/VideoTmp'
    ...
    save_dir = r'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/features/resnet50_frame_10'
    if not os.path.exists(save_dir):
        os.mkdir(save_dir)
