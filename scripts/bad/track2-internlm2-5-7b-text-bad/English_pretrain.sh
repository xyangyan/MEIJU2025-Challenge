...
--log_dir=./logs-internlm2-5-7b-text --checkpoints_dir=./checkpoints-internlm2-5-7b-text --gpu_ids=$gpu
...
--A_type=whisper-large-v3-FRA --V_type=clip-vit-large-patch14-FRA-org-0.5773 --L_type=internlm2_5-7b-chat-4-FRA
