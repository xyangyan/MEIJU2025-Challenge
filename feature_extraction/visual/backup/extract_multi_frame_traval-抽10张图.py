...
def visual_extraction():
    ...
    english_frame_dir = r'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/traVal_multi_frame_English_10'
    save_dir = r'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/features/resnet50_multi_frame_traVal'
    if not os.path.exists(save_dir):
        os.mkdir(save_dir)
