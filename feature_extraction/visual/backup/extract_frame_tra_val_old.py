...
try:
    ...
    print('wait debugger')
    debugpy.listen(("localhost", 31042))
...
def feature_extract(frame_dir, save_dir, feature_level='FRAME'):
    ...
    # model = torch.load('/home/zongtianyu/data/wangyuanxiang/xyy/reproduce/all_models/ferplus/resnet50_ferplus_dag.pth')
    # if isinstance(model, dict):
    #     for key, value in model.items():
    #         print(f"{key}: {value.shape}")
    # else:
    #     print("The loaded model is not in OrderedDict format.")
    # print(model)
    # exit()
    model = resnet50(pretrained=True).cuda()
    
    # model = nn.Sequential(*list(model.children())[:-2]).cuda()
    print(model)
...
# fram
    ...
    #         if not os.path.exists(f'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/video_frame_English_{sample_rate}'):
    #             os.mkdir(f'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/video_frame_English_{sample_rate}')
    #         frame_extract(video_path, f'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/video_frame_English_{sample_rate}', sample_rate=sample_rate)
    ...
    english_frame_dir = r'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/video_frame_English_10'
    save_dir = r'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/features/resnet50_frame_10_tmp'
    if not os.path.exists(save_dir):
        os.mkdir(save_dir)
