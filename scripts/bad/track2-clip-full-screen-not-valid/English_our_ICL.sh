...
--log_dir=./logs-clip-full-screen --checkpoints_dir=./checkpoints-clip-full-screen --gpu_ids=$gpu
...
--A_type=whisper-large-v3-FRA --V_type=clip-vit-large-patch14-FRA-full-screen --L_type=baichuan2-7b-base-4-FRA
...
--pretrained_path='/home/ccip/data/wangyuanxiang/xyy/reproduce/MEIJU2025-baseline-master/checkpoints-clip-full-screen/pretrain_English_run_2_1' --best_cvNo=1
--cvNo=$i"
