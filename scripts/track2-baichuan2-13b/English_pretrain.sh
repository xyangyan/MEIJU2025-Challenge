...
--log_dir=./logs-baichuan2-13B-new --checkpoints_dir=./checkpoints-baichuan2-13B-new --gpu_ids=$gpu
--input_dim_a=1024 --embd_size_a=128 --embd_method_a=maxpool
--input_dim_v=768 --embd_size_v=128  --embd_method_v=maxpool
--input_dim_l=5120 --embd_size_l=128  --hidden_size=128
--A_type=wavlm-large-FRA --V_type=clip-vit-large-patch14-FRA-org-0.5773 --L_type=baichuan2-13b-base-4-FRA
