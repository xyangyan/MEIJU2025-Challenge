...
--log_dir=./logs-face --checkpoints_dir=./checkpoints-face --gpu_ids=$gpu
...
--A_type=whisper-large-v3-FRA --V_type=clip-vit-large-patch14-FRA --L_type=baichuan2-7b-base-4-FRA
