...
def visual_extraction():
    ...
    for video in tqdm.tqdm(video_name):
        if 'mp4' in video:
            ...
            if not os.path.exists(f'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/testing_video_frame_English_{sample_rate}'):
                os.mkdir(f'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/testing_video_frame_English_{sample_rate}')
            frame_extract(video_path, f'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/testing_video_frame_English_{sample_rate}', sample_rate=sample_rate)
    ...
    english_frame_dir = r'/home/ccip/data/wangyuanxiang/xyy/reproduce/Track2/English/testing_video_frame_English_10'
