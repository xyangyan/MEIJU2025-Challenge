...
--log_dir=./logs-internvl-video --checkpoints_dir=./checkpoints-intervl-video --gpu_ids=$gpu
--input_dim_a=1280 --embd_size_a=128 --embd_method_a=maxpool
--input_dim_v=3200 --embd_size_v=128  --embd_method_v=maxpool
--input_dim_l=4096 --embd_size_l=128  --hidden_size=128
--A_type=whisper-large-v3-FRA --V_type=internvl-video-FRA --L_type=baichuan2-7b-base-4-FRA
